/**
 * Fake instruction tracer that outputs traced instructions into a LightHouse compatible format
 *
 */
...
{
    return [
        new host.functionAlias(StartTrace, "lh_trace_on"),
        new host.functionAlias(StopTrace, "lh_trace_off"),
    ];
}
